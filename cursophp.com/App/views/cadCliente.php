...
<head>
  ...
  <title>Clínica MãosQueMODELAM</title>
  ...
  <script type="../../js/jquery-3.4.1.min.js" type="text/javascript"></script>
  <script type="../../js/jquery.mask.min.js" type="text/javascript"></script>
  <script type="../../js/bootstrap-notify.min.js" type="text/javascript"></script>

  <style type="text/css">
    
    .container{
      margin: 30px 250px 100px auto;
      padding: 20px;
...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-header" style="color: #FF8000;" />ATENDIMENTO</li>
               <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="testes.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Testes</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <!-- h1 class="m-0 text-dark">Mãos que Modelam</h1 -->
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../model/painel.php">Home</a></li>
              <li class="breadcrumb-item active">Tela Dadastro v1</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <div class="container">
    ...
    <!-- Inicio do formulario -->
      <form method="post" action="../model/cadastroCliente.php" onsubmit="return confirmacao()">
        <div class="form-row">
          ...
          <div class="form-group col-md-3">
            ...
            <div class="input-group">
              ...
              <input type="text" id="telefone" class="form-control" name="telefone" data-mask="(38)99999-9999" / placeholder="(38)99999-9999">
            </div>
            <!-- /.input group -->
          </div>
        ...
        <div class="form-group col-md-4">
          ...
          <input name="cep" type="text" class="form-control" id="cep" maxlength="9" onblur="pesquisacep(this.value);" />
        </div>
        ...
        <div class="form-group col-md-3">
          ...
          <input name="estado" id="uf" type="text" class="form-control">
        </div>

        <div class="form-group col-md-3">
          <label for="inputAddress">IBGE</label>
