  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Clientes Cadastrados</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="container theme-showcase" role="main">
      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table table-striped table-hover"123
          +>
            <thead>
              <tr>
                <th>Código</th>
            ...
            <tbody>
              <?php while($rows = mysqli_fetch_assoc($resultado)){ ?>
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#myModal<?php echo $rows['id']; ?>">Visualizar</button>
                    <button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#exampleModal" 
                      data-whatever="<?php echo $rows['id']; ?>" 
                      data-whatevernome="<?php echo $rows['nome']; ?>"
                      data-whatevertelefone="<?php echo $rows['telefone']; ?>" 
                      data-whateveremail="<?php echo $rows['email']; ?>">Editar</button>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title text-center" id="myModalLabel"><?php echo $rows['nome']; ?></h4>
                      </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form method="POST" action="cadastroCliente.php" enctype="multipart/form-data">
