...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Inicio do formulario -->
      <form method="POST" action="cadastroProcedimento.php" onsubmit="return confirmacao()">
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <div class="input-group">
              ...
              <select class="custom-select" required name="duracao">
              <option value="1">1 hora</option>
              <option value="2">1h 30min</option>
              <option value="3">2 horas</option>
              <option value="4">2h 30min</option>
              <option value="5">3 horas</option>
            </select>
          ...
          <div class="form-group col-md-2">
            ...
            <div class="input-group">
              ...
              <select class="custom-select" required name="nro_sessao">
              <option value="1">1 Sessão</option>
              <option value="2">2 Sessões</option>
              <option value="3">4 Sessões</option>
              <option value="4">8 Sessões</option>
              <option value="5">10 ou mais</option>
            </select>
            <div class="invalid-feedback">Example invalid custom select feedback</div>
            </div>
          </div>
           ...
           <div class="form-group col-md-3">
            ...
            <div class="input-group">
              ...
              <input type="text" id="nome" name="valor" class="form-control" >
            </div>
          </div>
          ...
          <div class="form-group col-md-7">
            ...
            <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text"><i class="far fa-edit"></i>Descrição</span>
          </div>
            <textarea class="form-control" name="descricao" rows="2" aria-label="With textarea"></textarea>
        </div>
